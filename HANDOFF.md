...
> 새 세션 시작 시 이 파일 먼저. 최종 업데이트: **2026-07-22**
...
**보류 항목 (착수 시점 미정):**
- **n8n 쪽 스케줄 확정** — 사용자가 n8n 캔버스에 워크플로 4개(프로젝트/QnA/미팅·모집 상태/사전 미팅 녹취) 구성 완료. **미결: "사전 미팅 녹취"(meeting_transcripts, 전문 포함 무거운 파이프라인)에 Schedule Trigger를 넣을지** — `meetings_pipeline.md`엔 원래 "크론 없이 수동"으로 기록돼 있음. 자동화하기로 하면 문서도 같이 갱신.
