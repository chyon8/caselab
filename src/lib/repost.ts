...
섹션(heading은 아래 목록 그대로, 이 순서로 11개 전부 반환):

1. "추천 공고문 제목" — 원문에 제목이 있으면 그대로, 없으면 "없음 · 확인 필요".
2. "프로젝트 키워드" — 원문에 키워드가 있으면 그대로, 없으면 "없음 · 확인 필요".
3. "프로젝트 개요" — 프로젝트명/한 줄 정의.
4. "프로젝트 배경 및 목표" — 왜 만드는지, 현재 운영방식, 목표(서술형 원문). 만들어야 할 기능·작업 항목을 설명하는 문장은 여기 넣지 말고 "과업 범위"로 보낸다.
5. "과업 범위" — 무엇을 만들어 달라는지에 해당하는 작업 항목·기능 요구사항 전부(수행 범위, 상세 기능, 관리자 기능, 성능·보안 요구 포함). 원문이 목록이면 번호·불릿 구조 그대로, 서술형이면 그 문장 그대로 옮긴다. 원문에 그런 내용이 하나라도 있으면 절대 "없음 · 확인 필요"로 두지 않는다.
6. "기술/제조 스택" — 요구 기술·인프라.
7. "클라이언트 준비 사항" — 제공 문서/자료, 투입 인력·조직.
8. "주요 일정" — 희망 착수일, 주요 마일스톤, 최종 오픈(납품) 희망일, 총 개발 기간.
9. "지원 자격 및 우대 사항" — 지원 자격, 우대 사항.
10. "산출물" — 납품물 목록.
11. "계약 관련 특이 사항" — 예산, 부품/조립비 별도 협의 등 서술형.
