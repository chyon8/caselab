...
--
-- 페이로드는 id + 정수 두 컬럼뿐이라 전량을 보내도 Vercel 4.5MB 한도보다 훨씬 작다.
...
-- 방어 상한은 지원수 전용 수신 라우트의 MAX_PROPOSAL_COUNT_BATCH(10,000)와 같다.
-- 2026-09-16에 LIMIT 500을 정확히 채워 오래된 모집 건이 잘리는 것을 확인해 상향했다.
